  ...
  switch (action.type) {
    ...
    case FETCH_TOP_50_COINS_REQUEST:
      ...
      case FETCH_MARKET_CHART_REQUEST:
        return {
          ...state,
          marketChart: { ...state.marketChart, loading: true, error: null },
        };
      case FETCH_MARKET_CHART_SUCCESS:
        return {
          ...state,
          marketChart: { data: action.payload, loading: false, error: null },
        };
      case FETCH_MARKET_CHART_FAILURE:
        return {
          ...state,
          marketChart: { ...state.marketChart, loading: false, error: action.payload },
        };
